! function(n) {
    ...
    var o = {
        ...
        f = {
            init: function(e) {
                var o, a, t, r = e,
                    _ = Boolean(elementorFrontend.isEditMode()),
                    d = [],
                    i = {};
                _ && void 0 !== e ? (t = window.elementor.elements, o = r.data("id"), a = r.hasClass("elementor-inner-section"), n.each(t.models, function(e, t) {
