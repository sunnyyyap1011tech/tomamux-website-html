    ...
    t.prototype = {
        ...
        createFeeds: function(e) {
            e.whenFeedsCreated(i(".sbi").each(function(e) {
                ...
                var t = i(this),
                    o = void 0 !== t.attr("data-sbi-flags") ? t.attr("data-sbi-flags").split(",") : [],
                    a = void 0 !== t.attr("data-options") ? JSON.parse(t.attr("data-options")) : {};
        ...
        sendNeedsResizingToServer: function() {
            ...
            if (e.needsResizing.length > 0 && e.settings.resizingEnabled) {
                var s = i(this.el).find(".sbi_item").length,
                    o = void 0 !== e.settings.general.cache_all && e.settings.general.cache_all,
                    a = "";
                void 0 !== t.attr("data-locatornonce") && (a = t.attr("data-locatornonce")), n({
        ...
        setImageHeight: function() {
            ...
            sbi_photo_width_manual = e.find("#sbi_images").width() / s - n, e.find(".sbi_photo").css("height", t), e.find(".sbi-owl-nav").length && setTimeout(function() {
                ...
                t += parseInt(o) * (2 - i + 2), e.find(".sbi-owl-nav div").css("top", t)
            }, 100)
        },
        maybeRaiseSingleImageResolution: function(e, t, s) {
            ...
            if (!(e.hasClass("sbi_no_resraise") || e.hasClass("sbi_had_error") || e.find(".sbi_link_area").length && e.find(".sbi_link_area").hasClass("sbi_had_error")))
                if (o.length < 1) e.find(".sbi_link_area").length && e.find(".sbi_link_area").attr("href", window.sbi.options.placeholder.replace("placeholder.png", "thumb-placeholder.png"));
                    ...
                    if (c > d || a === window.sbi.options.placeholder || s) {
                        ...
                        if (a !== u && (e.find(".sbi_photo img").attr("src", u), e.find(".sbi_photo").css("background-image", 'url("' + u + '")')), d = c, "auto" === n.settings.imgRes) {
                            ...
                            e.find(".sbi_photo img").on("load", function() {
                                ...
                                if (1e3 !== t.get(0).naturalWidth && s > l && !b) {
                                    switch (n.settings.debugEnabled && console.log("rais res again for aspect ratio change " + a), b = !0, h = e.find(".sbi_photo").innerWidth(), g = n.getBestResolutionForAuto(h, s, e), c = 640, g) {
                                        case 320:
                                            c = 320;
                                            break;
                                        case 150:
                                    ...
                                    c > d && (u = o[c].split("?ig_cache_key")[0], t.attr("src", u), t.closest(".sbi_photo").css("background-image", 'url("' + u + '")')), "masonry" !== n.layout && "highlight" !== n.layout || (i(n.el).find("#sbi_images").smashotope(n.isotopeArgs), setTimeout(function() {
