! function(s) {
    "use strict";
    window.qodefAddonsCore = {}, qodefAddonsCore.shortcodes = {}, qodefAddonsCore.body = s("body"), qodefAddonsCore.html = s("html"), qodefAddonsCore.windowWidth = s(window).width(), qodefAddonsCore.windowHeight = s(window).height(), qodefAddonsCore.scroll = 0, s(document).ready(function() {
        qodefAddonsCore.scroll = s(window).scrollTop(), I.init(), e.init()
    }), s(window).resize(function() {
        qodefAddonsCore.windowWidth = s(window).width(), qodefAddonsCore.windowHeight = s(window).height()
    }), s(window).scroll(function() {
        qodefAddonsCore.scroll = s(window).scrollTop()
    }), s(window).on("load", function() {
        o.init()
    });
    var I = {
        init: function(e) {
            this.holder = s(".qodef-qi-swiper-container"), s.extend(this.holder, e), this.holder.length && this.holder.each(function() {
                I.initSlider(s(this))
            })
        },
        initSlider: function(o) {
            var t, n = I.getOptions(o),
                d = I.getEvents(o, n);
            ...
            }, 200) : new Swiper(o, Object.assign(n, d)), elementorFrontend.isEditMode() && elementor.channels.editor.on("change", function() {
                o[0].swiper.update()
            })
        },
        getOptions: function(e) {
            var o = void 0 !== e.data("options") ? e.data("options") : {},
                ...
                d = void 0 !== o.disablePartialValue && "" !== o.disablePartialValue ? parseInt(o.disablePartialValue) : "never",
                i = void 0 !== o.spaceBetween && "" !== o.spaceBetween ? o.spaceBetween : 0,
            ...
            var p = void 0 !== o.slidesPerView1440 && "" !== o.slidesPerView1440 ? parseInt(o.slidesPerView1440, 10) + n : "auto" === o.slidesPerView ? "auto" : 5 + n,
                ...
                b = void 0 !== o.slidesPerView1024 && "" !== o.slidesPerView1024 ? parseInt(o.slidesPerView1024, 10) + n : "auto" === o.slidesPerView ? "auto" : 3 + n,
                C = void 0 !== o.slidesPerView768 && "" !== o.slidesPerView768 ? parseInt(o.slidesPerView768, 10) + n : "auto" === o.slidesPerView ? "auto" : 2 + n,
                y = void 0 !== o.slidesPerView680 && "" !== o.slidesPerView680 ? parseInt(o.slidesPerView680, 10) + n : "auto" === o.slidesPerView ? "auto" : 1 + n,
                A = void 0 !== o.slidesPerView480 && "" !== o.slidesPerView480 ? parseInt(o.slidesPerView480, 10) + n : "auto" === o.slidesPerView ? "auto" : 1 + n;
            if (m || (s < 2 ? C = b = q = p = s : s < 3 ? b = q = p = s : s < 4 ? q = p = s : s < 5 && (p = s)), "never" !== d) switch (d) {
                case 1024:
                    b = Math.floor(b);
                case 768:
                    C = Math.floor(C);
        ...
        getEvents: function(r, a) {
            return {
                on: {
                    beforeInit: function() {
                        var e, o, t;
                        "vertical" === a.direction && (o = e = 0, (t = r.find(".qodef-e")).length && t.each(function() {
                            o = s(this).outerHeight(), e < o && (e = o)
                        }), 1 === a.slidesPerView && (r.css("height", e), t.css("height", e)))
                    },
                    init: function() {
                        var o, t, n, d, i;
                        r.addClass("qodef-swiper--initialized"), a.sliderScroll && (o = !1, t = r.hasClass("qodef-shortcode") ? r : r.parents(".qodef-shortcode"), n = t.hasClass("qodef--focus-in-viewport"), d = t.offset().top, i = t.offset().top + t.outerHeight(), n && window.addEventListener("wheel", function(e) {
                            var o = s(window).scrollTop() + e.deltaY;
                            (0 < e.deltaY && o < d || e.deltaY < 0 && i < o + qodefAddonsCore.windowHeight) && qodefAddonsCore.qodefIsInViewport.check(t, function() {
                                qodefAddonsCore.qodefScroll.disable(), s("html, body").stop().animate({
                                    scrollTop: d
                                }, 1200, function() {
                            ...
                            passive: !1
                        }), r.off().on("wheel", function(e) {
                            a.loop ? e.preventDefault() : ((e.originalEvent.deltaY < 0 && !r[0].swiper.isBeginning || 0 < e.originalEvent.deltaY && !r[0].swiper.isEnd) && e.preventDefault(), n && (e.originalEvent.deltaY < 0 && r[0].swiper.isBeginning ? (qodefAddonsCore.qodefScroll.disable(), s("html, body").stop().animate({
                                scrollTop: Math.max(0, d - qodefAddonsCore.windowHeight)
                            }, 1200, function() {
                                qodefAddonsCore.qodefScroll.enable()
                            })) : 0 < e.originalEvent.deltaY && r[0].swiper.isEnd && (qodefAddonsCore.qodefScroll.disable(), s("html, body").stop().animate({
                                scrollTop: i
                            }, 1200, function() {
                                qodefAddonsCore.qodefScroll.enable()
                            })))), o || (o = !0, 0 < e.originalEvent.deltaY ? r[0].swiper.slideNext() : r[0].swiper.slidePrev(), setTimeout(function() {
                                o = !1
                            }, 1e3))
                        })), qodefAddonsCore.body.trigger("qodefAddons_trigger_after_swiper_init", [r, a])
                    }
                }
            }
        }
    };
    qodefAddonsCore.qodefSwiper = I, "function" != typeof Object.assign && (Object.assign = function(e) {
    ...
    var e = {
        init: function() {
            if (this.holder = s(".qodef-qi-fslightbox-popup"), this.holder.length) {
    ...
    var o = {
        init: function() {
            this.holder = s(".qodef-qi--has-appear:not(.qodef-qi--appeared)"), this.holder.length && this.holder.each(function() {
                var e, o, t = s(this),
                    e = (e = 10, o = 400, Math.floor(Math.random() * (o - e) + e)),
                    n = s(this).attr("data-appear-delay");
...
function(d) {
    ...
    var i = {
        init: function(e) {
            this.holder = d(".qodef-layout--qi-masonry"), d.extend(this.holder, e), this.holder.length && this.holder.each(function() {
                i.createMasonry(d(this))
            })
        },
        reInit: function(e) {
            this.holder = d(".qodef-layout--qi-masonry"), d.extend(this.holder, e), this.holder.length && this.holder.each(function() {
                var e = d(this).find(".qodef-grid-inner"),
                    o = e.find(".qodef-grid-item"),
                    t = e.find(".qodef-qi-grid-masonry-sizer").width(),
                    n = parseInt(e.css("column-gap"));
                o.css("width", t), "function" == typeof e.isotope && void 0 !== e.data("isotope") && (d(this).hasClass("qodef-items--fixed") && i.setFixedImageProportionSize(e, o, t, n), e.isotope({
                    layoutMode: "packery",
        ...
        createMasonry: function(e) {
            var o = e.find(".qodef-grid-inner"),
                ...
                d = parseInt(o.css("column-gap"));
            t.css("width", n), qodefAddonsCore.qodefWaitForImages.check(o, function() {
                "function" != typeof o.isotope || o.hasClass("qodef--masonry-init") || (e.hasClass("qodef-items--fixed") && i.setFixedImageProportionSize(o, t, n, d), o.isotope({
                    layoutMode: "packery",
                    itemSelector: ".qodef-grid-item",
                    percentPosition: !0,
                    packery: {
        ...
        setFixedImageProportionSize: function(e, o, t, n) {
            var d = e.find(".qodef-item--square"),
                i = e.find(".qodef-item--landscape"),
    ...
    var u = {
        ...
        initItem: function(e) {
            var o = ["h1", "h2", "h3", "h4", "h5", "h6"],
                ...
                d = void 0 !== t.data("excluded-cids") ? t.data("excluded-cids") : "",
            ...
            })), (o = u.prepareHeadings(n, d, o)).length && (o.each(function(e) {
                var o, t, n, d = h(this),
                    i = d.clone(),
                    r = u.prepareId(c, i, l);
                l += r.id + ";", f[e] = {
